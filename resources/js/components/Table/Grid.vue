        ...
        <el-table :data="data.data"
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-button v-if="subscribe"   @click="handleSubscribe(scope.$index, scope.row)" :type="scope.row.isSubscribe ? 'primary' : 'default'" size="mini" slot="button">Subscription</el-button>
                    <el-button
                        size="mini"
