        ...
        <div class="layout">
            <div  class="layout-topbar clearfix">
                <div class="layout-name" :class="{'sider-mini': isCollapse}">
                    <router-link class="full" to="/" v-if="!isCollapse">Publish and Subscribe</router-link>
                ...
                <div class="layout-nav">
                    <el-dropdown v-if="$root.handleNotification" @command="handleCommand" trigger="click">
                        <span class="el-dropdown-link">Notifications<i class="el-icon-arrow-down el-icon--right"></i>
                            </span>
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item
                                v-for="(notification, index) in $root.store.state.user.notifications"
                                :command="notification, index"
                                :key="`${index}-${notification.id}`">{{notification.data.message}}
                                </el-dropdown-item>
                    ...
                    <el-dropdown v-else trigger="click">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item>No Notification</el-dropdown-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleCallback(vm, command, index){
                axios.get(`/api/user/notification/${command.id}`).then(function () {
                    vm.$root.store.dispatch('handleDeleteNotification', index.$attrs.index)
